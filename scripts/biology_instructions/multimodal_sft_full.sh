...
enable_list="multimodal weight_a weight_b norm"


options="$base_options \
    --multimodal \
    --multimodal-k-tokens 64 \
    --multimodal-model-ckpt-path your_pretrained_bert_checkpoint_path \
    --multimodal-tokenizer-path your_bert_tokenizer_path \
    --multimodal-tokenizer-name nt \
    --experiment-name multimodal_instruct_tuning_exp_1 \
    --show-loss-step 1 \
