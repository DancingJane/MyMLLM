...
if __name__ == '__main__':
    ...
    # 准备输入数据
    tokenizer = AutoTokenizer.from_pretrained('/tos-bjml-ai4agr/mazhe/model_dir/nucleotide-transformer')
    ...
    # 计算词汇表大小
    def get_tokenizer_vocab_size(tokenizer):
        try:
            # 优先尝试直接获取vocab_size属性
